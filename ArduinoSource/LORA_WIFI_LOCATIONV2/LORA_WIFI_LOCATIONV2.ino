// Testsketch: WIFI UPLOAD GEHT AUS IRGENDEINEM GRUND NICHT
//Features:
...
//define geraet7 //Schreibtischlampe  -> TTN StackV3
#define geraet8 //Lora Bike Light  -> TTN StackV3
